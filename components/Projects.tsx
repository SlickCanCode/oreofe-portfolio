...
/* Devicon "github-original" with fill="currentColor" so it follows the theme */
...
export default function Projects() {
  return (
    <section className="section-pad projects" id="work">
      <Reveal>
              ...
              <div className="small-project-copy">
                ...
                <div className="small-project-bottom">
                  ...
                  <div className="project-actions">
                     ...
                     <a className="project-link project-link--primary"
